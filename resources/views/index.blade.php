      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 ftco-animate">
			<form class="billing-form ftco-bg-dark p-3 p-md-5" method="POST" action="{{ route('register') }}">
                @csrf
				<h3 class="mb-4 billing-heading">Register</h3>
                 ...
                 <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Username">
                        </div>
                 </div>
	          	  <div class="col-md-12">
	                <div class="form-group">
                ...
                <div class="col-md-12">
	                <div class="form-group">
	                    ...
	                    <input type="password" class="form-control password_confirmation" required placeholder="Password">
	                </div>
